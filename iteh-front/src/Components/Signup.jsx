  ...
  return (
    ...
    <div className={l.container}>
      <div className={l.form_container}>
        <h2 className={l.proba}>REGISTRUJ SE</h2>
        <form onSubmit={ handleRegister }>
          ...
          <button type="submit" className={l.submit_btn}>REGISTRUJ SE</button>
        </form>
        <p>
          Već imaš nalog? <Link to="/" className={l.link}>Prijavi se</Link>
        </p>
      </div>
    </div>
    </body>
